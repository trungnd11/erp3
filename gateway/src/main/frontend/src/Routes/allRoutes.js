...
import KanbanBoard1 from "../pages/Tasks/KanbanBoard/Index";
import KanbanBoard from "../office-component/kaban-board/KanbanBoard.js";
...
import ListForm from "../pages/FormBuilder/ListForm";
import CreateNewFormBuilder from "../pages/FormBuilder/CreateNewFormBuilder/index";
import EditFormBuilder from "../pages/FormBuilder/EditFormBuilder";
import ListProject from "../office-component/project/project-list/ListProject";
import ViewCustomForm from "../pages/FormBuilder/ViewCustomForm";
import EmployeeList from "../pages/EmployeeList/EmployeeList";
import Profiles from "../pages/EmployeeList/Profiles";
import TaskDetail from '../office-component/TaskDetail/index';
import ManagementChart from "../pages/ManagementChart";
import TaskWorkflow from "../pages/Workflow";
import ListWorkFlows from "../pages/Workflow/ListWorkFlow";
import CreateNewWorkflow from "../pages/Workflow/pages/CreateNewWorkflow";
...
import ListEmployeePart from "../pages/OrganizationalChart/listEmployees";
...
const authProtectedRoutes = [
  { path: "/utilities-group/group", component: GroupUser, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"]},
  { path: "/hrcenter-employee-profile/employee-group", component: GroupUser, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/hrcenter-organizational-chart", component: OrganizationalChart, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/hrcenter/employees-department/:part/:id", component: ListEmployeePart, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/hrcenter-management-chart", component: ManagementChart, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/team", component: TeamManagement, hasAnyAuthorities: ["ROLE_PART_LEADER"] },
  { path: "/hrcenter-employee-profile/employee-list", component: EmployeeList, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/dashboard-analytics", component: DashboardAnalytics },
  {
    path: "/hrcenter-employee-profile/employee-list/profiles/:id",
    component: Profiles,
  },
  // {
  //   path: "/dashboard-crm",
  ...
  //Project List
  { path: "/apps-list-projects", component: ListProject },

  { path: "/pages-profile/:id", component: UserProfile },
  // {
  //   path: "/hrcenter-employee-profile/employee-list/profiles/:id",
  //   component: Profiles,
  // },
  ...
  { path: "/apps-tasks-kanban", component: KanbanBoard1 },
  { path: "/apps-kanban/:projectId", component: KanbanBoard },
  ...
  //Account
  { path: "/user-management", component: AccountManagement,hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/user/:id", component: UserDetail, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/position", component: PositionManagement, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/position/:id", component: EditPosition, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },
  { path: "/role-management", component: RoleManagement, hasAnyAuthorities: ["ROLE_READ_EMPLOYEE", "ROLE_CREATE_EMPLOYEE", "ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"] },

  // { path: "/form-builder", component: FormBuilder },
  { path: "/form-builder", component: ListForm },
  { path: "/form-builder/create", component: CreateNewFormBuilder },
  { path: "/form-builder/:id", component: EditFormBuilder },
  { path: "/form-builder/:id/view", component: ViewCustomForm },

  //workflow
  { path: "/create-process", component: TaskWorkflow },
  { path: "/create-process/list-workflows", component: ListWorkFlows },
  { path: "/new-workflow", component: CreateNewWorkflow },
...
const publicRoutes = [
  ...
  { path: "/auth-403", component: Basic403 },
