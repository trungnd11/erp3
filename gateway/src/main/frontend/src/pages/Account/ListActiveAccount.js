...
import { getUserActive } from "../../api/account";
import PaginationTable from "../../Components/pagination/PaginationTable";
import { formatDate } from "../../utils/date";
import { showErrorNotice } from "../../utils/toastify";

function ListActiveAccount({keySearch}, ref) {
  ...
  const getData = (key = "", page, size, sort) => {
    setLoading(true);
    getUserActive(key, page, size, sort)
      .then((res) => {
...
export default forwardRef(ListActiveAccount);
