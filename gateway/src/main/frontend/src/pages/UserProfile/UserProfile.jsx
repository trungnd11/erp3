...
import { fetchDataEmployeebyId } from '../../store/employee/employees';
...
const UserProfile = () => {
    ...
    const linkToProfiles = (id) => {
        linkPath.push(`/hrcenter-employee-profile/employee-list/profiles/${data.dataEmployeebyId.id}`);
    }
    ...
    const getListSpecialize = async () => {
        const response = await employeeApi.getSpecializeByEmployeeId(id);
                        ...
                        <Row className="g-4">
                            <div className="col-auto">
                                <div className="avatar-lg">
                                    <img
                                    src={data.dataEmployeebyId.avatarPic || avatar11}
                            ...
                            <Col>
                                <div className="p-2">
                                    <h3 className="text-white mb-1">{data.dataEmployeebyId ? data.dataEmployeebyId.fullName : ""}</h3>
                                    <p className="text-white-75">
                                        {data.dataEmployeebyId ? data.dataEmployeebyId.empPositionName : ""}
                                        &nbsp; : &nbsp; 
                                        {data.dataEmployeebyId ? data.dataEmployeebyId.descJob : ""}
                                    </p>
                                    <div className="hstack text-white-50 gap-1">
                                        <div className="me-2"><i
                                            className="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>
                                            {data.dataEmployeebyId ? data.dataEmployeebyId.idReleasePlace : ""} , {data.dataEmployeebyId ? data.dataEmployeebyId.country : ""}
                                        </div>
                                        <div><i
                                            className="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{data.dataEmployeebyId ? data.dataEmployeebyId.curretPlace : ""}
                                        </div>
                                    </div>
                                </div>
                            </Col>
                            ...
                            <div>
                                <div className="d-flex">
                                    ...
                                    <div className="flex-shrink-0">
                                        <Button type='button'  className="btn btn-success" onClick={() => linkToProfiles()}><i
                                            className="ri-edit-box-line align-bottom"></i> Edit Profile</Button>
                                    </div>
                                </div>
                                    ...
                                    <TabPane tabId="1">
                                        <Row>
                                            <Col xxl={3}>
                                                            ...
                                                            <Table className="table-borderless mb-0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td className="text-muted">{data.dataEmployeebyId ? data.dataEmployeebyId.fullName : ""}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th className="ps-0" scope="row">User Name :</th>
                                                                        <td className="text-muted">{data.dataEmployeebyId ? data.dataEmployeebyId.account.username : ""}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th className="ps-0" scope="row">Mobile :</th>
                                                                        <td className="text-muted">
                                                                        <td className="text-muted">{data.dataEmployeebyId ? data.dataEmployeebyId.phoneNumber : ""}</td>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th className="ps-0" scope="row">E-mail :</th>
                                                                        <td className="text-muted">
                                                                        {data.dataEmployeebyId ? data.dataEmployeebyId.email : ""}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th className="ps-0" scope="row">Location :</th>
                                                                        <td className="text-muted">
                                                                        {data.dataEmployeebyId ? data.dataEmployeebyId.empDepartmentName : ""}
                                                                        </td>
                                                                    </tr>
                                                                    {/* <tr>
                                                ...
                                                <Card>
                                                    <CardBody>
                                                        <h5 className="card-title mb-4">SPECIALIZE</h5>
                                                        <div className="d-flex flex-wrap gap-2 fs-15">
                                                            ...
                                                            {specialize.data.map(dataS => <Link key={dataS.id} to="#" className="badge badge-soft-primary">{dataS.specialize}</Link>)}
                                                        </div>
                                                    </CardBody>
                                                </Card>
                                            ...
                                            <Col xxl={9}>
                                                <Card>
                                                    <CardBody>
                                                        ...
                                                        <p>HoangQuangMinh (サイタマ, Saitama) is the main protagonist of the series and the titular One-Punch Man. 
                                                            He is the most powerful being to exist in the series. 
                                                            Saitama faces a self-imposed existential crisis, 
                                                            as he is now too powerful to gain any thrill from battle.</p>

                                                        <p>Initially just a hero for fun, Saitama later registers to be a professional hero for the Hero Association upon realizing that nobody recognizes him as a hero, and defends his home in Z-City from monsters, villains, and other threats.
                                                             Under the Hero Association, he is assigned the hero name Caped Baldy (ハゲマント, Hagemanto; Viz: Bald Cape)  and is currently B-Class Rank 7.</p>
                                                        <Row>
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        <p className="mb-1">{data.dataEmployeebyId ? data.dataEmployeebyId.empPositionName : ""} :</p>
                                                                        <h6 className="text-truncate mb-0">{data.dataEmployeebyId ? data.dataEmployeebyId.descJob : ""}</h6>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <Link to="#" className="fw-semibold">www.ancaotech.com</Link>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                        </Row>
