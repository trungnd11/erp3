    ...
    if (props.data && d3Container.current) {
      ...
      chart
        ...
        <div class="style-tree-department" style="padding-top:30px;background-color:none;margin-left:1px;height:${d.height}px;overflow:visible">
          ...
          <img src=" ${(d.data.teamLead && d.data.teamLead.avatar) || user}" style="margin-top:-30px;margin-left:${d.width / 2 - 30}px;border-radius:100px;width:60px;height:60px;" />
          ...
          <div style="padding:20px; padding-top:35px;text-align:center">
            ...
            <div class="manager" style="color:#404040;font-size:13px;margin-top:4px"><span>Team Lead:</span> ${(d.data.teamLead && d.data.teamLead.fullname) || ''} </div>
          </div> 
          <div style="display:flex;justify-content:space-between;padding-left:5px;padding-right:4px; margin-bottom:5px">
            ...
            <div> Oversees: <span class="dependent-units">${0}</span> 👤</div>    
          </div>    
      </div>
          `)
        .render();
