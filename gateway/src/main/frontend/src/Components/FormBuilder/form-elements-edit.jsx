    ...
    return (
      <div>
        <div className="clearfix" style={{display: 'flex', alignItems: 'center'}}>
          <h4 className="float-left" style={{flexGrow: 1}}>{this.props.element.text}</h4>
          <i className="float-right fas fa-times dismiss-edit" style={{marginTop: 0}} onClick={this.props.manualEditModeOff}></i>
        </div>
        ...
        {this.props.element.hasOwnProperty('field_name') &&
          <div className='form-group'>
            <label><IntlMessages id="field-name" /></label>
            <input id="field-name" type="text" className="form-control" defaultValue={this.props.element.field_name}  onBlur={this.updateElement.bind(this)} onChange={this.editElementProp.bind(this, 'field_name', 'value')}></input>
          </div>
        }
