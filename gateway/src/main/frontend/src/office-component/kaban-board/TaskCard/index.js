...
const openDelRecord = props.openDelRecord
  ...
  return (
    <React.Fragment>
      <Offcanvasview openView={openView} taskData={data} closeView={closeView} />
        ...
        <div className="tasks-list">
          <SimpleBar className="tasks-wrapper px-3 mx-n3">
            <div id="unassigned-task" className="tasks">
              <Card
                className={`${style.border_card_kanban} tasks-box`}
              ...
              >
                <CardBody>
                  <div className="d-flex mb-2">
                    <h6 className="fs-15 mb-0 flex-grow-1 text-truncate">
                      {data.isTaskIdHeader ? (
                        ...
                        <Link to={`/tasks-detail/${data.id}`} className="text-body">
                          {data.title}
                        </Link>
                      )}
                    </h6>
                  ...
                  {data.isTaskId && (
                    <div className="mb-3">
                      ...
                      <div
                        className={
                          "progress rounded-3 progress-sm bg-soft-" +
                ...
                {data.isProgessBarFooter && (
                  <div
                    className={
                      "progress progress-sm bg-soft-" + data.progressBarColor
                    }
                  >
                    <div
                      className={"progress-bar bg-" + data.progressBarColor}
