...
const Navdata = () => {
  ...
  //state data
  const [isHrCenter, setIsHrCenter] = useState(false);
  ...
  //Work
  const [isUtilities, setUtilities] = useState(false);

  //Account management
  const [isAccManagement, setAccManagement] = useState(false);
  ...
  useEffect(() => {
    ...
    if (iscurrentState !== "HR Center") {
      setIsHrCenter(false);
    }
    if (iscurrentState !== "Work") {
      setWork(false);
    }
    if (iscurrentState !== "Utilities") {
      setUtilities(false);
    }
    if (iscurrentState !== "User Management") {
      setAccManagement(false);
    }
  ...
  const hasAuthory = (arrAuthories) => {
    return hasAnyAuthority(account ? account.authorities : [], arrAuthories);
  }
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: "ri-team-fill",
      link: "/hrcenter",
      stateVariables: isHrCenter,
      show: hasAuthory(["ROLE_CREATE_EMPLOYEE","ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE", "ROLE_PART_LEADER"]),
      click: (e) => {
        e.preventDefault();
        setIsHrCenter(!isHrCenter);
        setIscurrentState("HR Center");
        updateIconSidebar(e);
      },
      subItems: [
        {
          ...
          link: "/hrcenter-organizational-chart",
          parentId: "hrcenter",
          show: hasAuthory(["ROLE_CREATE_EMPLOYEE","ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"]),
        },
        {
          id: "managementchart",
          label: "Management Chart",
          link: "/hrcenter-management-chart",
          parentId: "hrcenter",
          show: hasAuthory(["ROLE_CREATE_EMPLOYEE","ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"]),
        },
        {
          ...
          link: "/team",
          parentId: "hrcenter",
          show: hasAuthory(["ROLE_PART_LEADER"]) && account.username !== 'admin',
        },
        // {
        //   id: "employeeprofile",
        //   label: "Employee Profile",
        //   link: "/hrcenter-employee-profile",
        //   parentId: "hrcenter",
        // },
        {
          id: "employeemanagement",
          label: "Employee Management",
          link: "/hrcenter-employee-management",
          parentId: "hrcenter",
          isChildItem: true,
          stateVariables: isEmployeeManagement,
          click: (e) => {
            e.preventDefault();
            setIsEmployeeManagement(!isEmployeeManagement);
          },
          show: hasAuthory(["ROLE_CREATE_EMPLOYEE","ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"]),
          childItems: [
            {
              id: "employeelist",
              label: "Employee List",
              link: "/hrcenter-employee-profile/employee-list",
              parentId: "employeemanagement",
              show: hasAuthory(["ROLE_CREATE_EMPLOYEE","ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"]),
            },
            // {
            //   id: "employeeimport",
            //   label: "Employee Import",
            //   link: "/hrcenter-employee-profile/employee-import",
            //   parentId: "employeemanagement",
            //   show: hasAuthory(["ROLE_CREATE_EMPLOYEE","ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"]),
            // },
            // {
            //   id: "employeegroup",
            //   label: "Employee Group Management",
            //   link: "/hrcenter-employee-profile/employee-group",
            //   parentId: "employeemanagement",
            //   show: hasAuthory(["ROLE_CREATE_EMPLOYEE","ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"]),
            // },
          ],
    ...
    },
    {
      ...
      label: "Utilities",
      icon: " ri-briefcase-4-fill",
      link: "/apps-list-utilities",
      stateVariables: isUtilities,
      click: (e) => {
        e.preventDefault();
        setUtilities(!isUtilities);
        setIscurrentState("Utilities");
        updateIconSidebar(e);
      },
      show: hasAuthory(["ROLE_CREATE_EMPLOYEE","ROLE_UPDATE_EMPLOYEE", "ROLE_REMOVE_EMPLOYEE"]),
      subItems: [
    ...
    },
    {
      ...
      stateVariables: isAccManagement,
      click: (e) => {
        e.preventDefault();
        setAccManagement(!isAccManagement);
