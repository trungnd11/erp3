...
import com.vdc.hrservice.config.ApplicationProperties;
import com.vdc.hrservice.management.SecurityMetersService;
...
public class TokenProvider {
    ...
    public TokenProvider(ApplicationProperties applicationProperties, SecurityMetersService securityMetersService) {
        byte[] keyBytes;
        String secret = applicationProperties.getBase64Secret();
