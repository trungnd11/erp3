...
@Table
@Data
public class EmployeeTraining extends AbstractAuditingEntity {
  ...
  public static EmployeeTraining of(EmployeeAccountDto trainingDto) {
    ModelMapper mapper = new ModelMapper();
    return mapper.map(trainingDto, EmployeeTraining.class);
  }
}
